...
public:
    ...
    inline const char* getIcon()
    {
        ...
        case ImGuiToastType::None:
            return nullptr;
        case ImGuiToastType::Success:
            return ICON_FA_CHECK; // Font Awesome 6
        case ImGuiToastType::Warning:
            return ICON_FA_BELL_EXCLAMATION; // Font Awesome 6
        case ImGuiToastType::Error:
            return ICON_FA_DO_NOT_ENTER; // Font Awesome 6 
        case ImGuiToastType::Info:
            return ICON_FA_INFO; // Font Awesome 6
        default:
            return nullptr;
        }
    }
