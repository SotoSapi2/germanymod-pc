...
namespace ImGui
{
    ...
    IMGUI_API bool          SubTab(bool selected, const char* label, const ImVec2& size_arg);
    ...
    IMGUI_API bool          CustomInputText(const char* label, const char* hint, float sizeX, static char buf[], size_t buf_size, ImGuiInputTextFlags flag);
