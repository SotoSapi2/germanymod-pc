...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    const float w = window->Size.x - arrow_size;
...
bool ImGui::BeginComboPopup(ImGuiID popup_id, const ImRect& bb, ImGuiComboFlags flags)
{
    ...
    PushStyleColor(ImGuiCol_Border, ImGui::GetColorU32(ImGuiCol_Button));
    PushStyleColor(ImGuiCol_PopupBg, ImVec4(0,0,0,0.8));
    PushStyleVar(ImGuiStyleVar_PopupBorderSize, 1.5f);
    PushStyleVar(ImGuiStyleVar_PopupRounding, 5);
    PushStyleVar(ImGuiStyleVar_WindowPadding, ImVec2(g.Style.FramePadding.x * 2.0, g.Style.WindowPadding.y)); // Horizontally align ourselves with the framed text
